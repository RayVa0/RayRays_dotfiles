...
function fish_greeting
  ...
  random choice { 'こんにちは', '死', 'ようこそ', 'Welcome to the Arch Linux command line interface', 'Hello, Dave', '"I am not a huge fan of incest I just think it is cool." -Mr Longingly', 'Fishing in just to fish out', 'Betcha you cant stick it', 'Variable refresh rate is necessary for even frame pacing in most scenarios' \
                  ...
                  ,'I hate children I am the like the opposite of a pedophile', 'Hype moments and aura', 'Hype aura and moments', 'Invoking the \'food\' command will print to the terminal the food which you desire the most!', 'Friendship ended with hyperland now KDE is my best friend' }| lolcat
