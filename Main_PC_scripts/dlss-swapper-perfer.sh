...
export DXVK_NVAPI_DRS_NGX_DLSS_RR_MODE=custom
export DXVK_NVAPI_DRS_NGX_DLSS_SR_OVERRIDE_SCALING_RATIO=40
export DXVK_NVAPI_SET_NGX_DEBUG_OPTIONS=DLSSIndicator=1024,DLSSGIndicator=1
